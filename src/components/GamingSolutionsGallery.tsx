...
const gamingSolutionsData = [
  {
    id: 1,
    image: 'https://i.ytimg.com/vi/wFE2WScyzRk/hqdefault.jpg',
    title: 'Gaming Solution Video 1',
    videoId: 'wFE2WScyzRk' 
  },
  {
    id: 2,
    image: 'https://i.ytimg.com/vi/_OWL54c23tw/hqdefault.jpg',
    title: 'Gaming Solution Video 2',
    videoId: '_OWL54c23tw' 
  },
  {
    id: 3,
    image: 'https://i.ytimg.com/vi/fO0BAb6xRKI/hqdefault.jpg',
    title: 'Gaming Solution Video 3',
    videoId: 'fO0BAb6xRKI' 
  },
  {
    id: 4,
    image: 'https://i.ytimg.com/vi/slCxSoSUVdg/hqdefault.jpg',
    title: 'Gaming Solution Video 4',
    videoId: 'slCxSoSUVdg' 
  },
  {
    id: 5,
    image: 'https://i.ytimg.com/vi/h7Ij3SFDM90/hqdefault.jpg',
    title: 'Gaming Solution Video 5',
    videoId: 'h7Ij3SFDM90' 
  },
  {
    id: 6,
    image: 'https://i.ytimg.com/vi/GwPl2iA6r-o/hqdefault.jpg',
    title: 'Gaming Solution Video 6',
    videoId: 'GwPl2iA6r-o' 
  },
  {
    id: 7,
    image: 'https://i.ytimg.com/vi/PBjm2LWQLxQ/hqdefault.jpg',
    title: 'Gaming Solution Video 7',
    videoId: 'PBjm2LWQLxQ' 
  },
  {
    id: 8,
    image: 'https://i.ytimg.com/vi/avhalpiTRZc/hqdefault.jpg',
    title: 'Gaming Solution Video 8',
    videoId: 'avhalpiTRZc' 
  }
];

export default function GamingSolutionsGallery({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) {
          ...
          <div className="max-w-7xl mx-auto px-6 py-12">
            <div className="flex items-center justify-between mb-12 sticky top-0 bg-zinc-950/80 backdrop-blur-md py-4 z-10 border-b border-zinc-800">
              <h2 className="text-3xl md:text-5xl font-display font-bold">
                Gaming Solutions <span className="text-neon-green">Videos</span>
              </h2>
              <button 
                onClick={onClose}
