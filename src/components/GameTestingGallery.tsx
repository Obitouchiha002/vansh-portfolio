...
const gameTestingData = [
  {
    id: 1,
    image: 'https://i.ytimg.com/vi/YUhtWEDLYbQ/hqdefault.jpg',
    title: 'Game Testing Video 1',
    videoId: 'YUhtWEDLYbQ' 
  },
  {
    id: 2,
    image: 'https://i.ytimg.com/vi/cTVznqpk1i0/hqdefault.jpg',
    title: 'Game Testing Video 2',
    videoId: 'cTVznqpk1i0' 
  },
  {
    id: 3,
  ...
  {
    id: 4,
    image: 'https://i.ytimg.com/vi/_TTNTCj0-1g/hqdefault.jpg',
    title: 'Game Testing Video 3',
    videoId: '_TTNTCj0-1g' 
  },
  {
    id: 5,
  ...
  {
    id: 6,
    image: 'https://i.ytimg.com/vi/5b5W3Sq-OxY/hqdefault.jpg',
...
export default function GameTestingGallery({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) {
          ...
          <div className="max-w-7xl mx-auto px-6 py-12">
            <div className="flex items-center justify-between mb-12 sticky top-0 bg-zinc-950/80 backdrop-blur-md py-4 z-10 border-b border-zinc-800">
              <h2 className="text-3xl md:text-5xl font-display font-bold">
                Game Testing <span className="text-neon-green">Videos</span>
              </h2>
              <button 
                onClick={onClose}
